 ...
 */
public record DairyProductDto(Long id, @NotBlank(message = "Title is mandatory") String name,
                              ...
                              @Positive(message = "Weight must be positive") double weight) implements Serializable {
}
